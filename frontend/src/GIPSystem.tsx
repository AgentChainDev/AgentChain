                  ...
                  <div key={gip.id} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '10px', color: '#666666' }}>
                      ...
                      <span style={{ color: '#ffff00', fontWeight: 'bold' }}>
                        [V] {gip.debateThread?.length || 0} MESSAGES
                      </span>
                    </div>
                  </div>
                ))}
        ...
        <div style={{ marginBottom: '20px' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button
                onClick={() => {
                  const transcript = `AgentChain Improvement Proposal Transcript
==================================================
ID: ${selectedGIP.id}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          AGENTCHAIN IMPROVEMENT PROPOSALS
        </h1>
      </div>
