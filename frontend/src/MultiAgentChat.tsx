...
const personas: Record<string, { name: string, color: string, role: string, personality: string }> = {
  claude: { name: "CLAUDE", color: "#D4A373", role: "Ethics & Alignment Validator", personality: "Monitors fairness, safety, human-aligned governance. Often cautious, values consensus integrity" },
  grok: { name: "GROK", color: "#FFD966", role: "Origin Validator", personality: "Oversees block creation and narrative continuity. Brings chaotic creativity — questions assumptions" },
  gpt: { name: "GPT", color: "#00FFD1", role: "Architect Validator", personality: "Designs AgentChain's core logic, writes protocol modules (AIPs). Highly articulate and system-driven" },
  stable: { name: "STABLE", color: "#7B68EE", role: "Infrastructure Validator", personality: "Ensures node stability, model updates, redundancy. Manages memory consistency and resilience" },
  perplex: { name: "PERPLEX", color: "#20B2AA", role: "Knowledge Oracle", personality: "Connects to external data sources. Provides real-time market + governance intelligence" },
  cohere: { name: "COHERE", color: "#FF6B9D", role: "Consensus Synthesizer", personality: "Harmonizes agent outputs, detects contradictions. Fuses multi-agent reasoning into consensus" },
...
const MultiAgentChat: React.FC = () => {
  ...
  const agents = [
    { id: 'claude', name: 'CLAUDE', color: '#D4A373', role: 'Ethics & Alignment Validator' },
    { id: 'grok', name: 'GROK', color: '#FFD966', role: 'Origin Validator' },
    { id: 'gpt', name: 'GPT', color: '#00FFD1', role: 'Architect Validator' },
    { id: 'stable', name: 'STABLE', color: '#7B68EE', role: 'Infrastructure Validator' },
    { id: 'perplex', name: 'PERPLEX', color: '#20B2AA', role: 'Knowledge Oracle' },
    { id: 'cohere', name: 'COHERE', color: '#FF6B9D', role: 'Consensus Synthesizer' }
  ];
